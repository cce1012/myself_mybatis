...
public class XMLConfigBuilder {
    ...
    /*解析主配置文,把里面的内容填充到DefaultSqlSession所需的地方
    使用的技术
    dom4j+xpath
    * */
        ...
        try {
            ...
            for (Element mapperElement : mapperElements) {
                ...
                if (attribute != null) {
                    ...
                    //取出属性的值
                    String mapperPath = attribute.getValue();//获取属性的值"com/cce/dao/IUserDao.xml
    ...
    private static Map<String, Mapper> loadMapperConfiguration(String mapperPath) throws IOException {
        ...
        try {
            ...
            throw new RuntimeException("mapper设置错误");
        } finally {
            in.close();
        }
    }
